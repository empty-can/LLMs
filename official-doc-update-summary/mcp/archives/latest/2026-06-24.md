...
1. [**Primitive Grouping インタレストグループ憲章を新規追加**](../latest-detail/2026-06-24.md#1-primitive-grouping-インタレストグループ憲章を新規追加):  
...
- [**Primitive Grouping 憲章（Primitive Grouping Charter）**](../latest-detail/2026-06-24.md#1-primitive-grouping-インタレストグループ憲章を新規追加) ([MCP Docs](https://modelcontextprotocol.io/community/interest-groups/primitive-grouping)):  
