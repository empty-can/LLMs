...
1. [**MCP Security Interest Group の新設**](../latest-detail/2026-06-16.md#1-mcp-security-interest-group-の新設):  
  MCP 固有の脅威整理、セキュリティ関連提案のレビュー、検証済み課題の Working Group / SEP 化を担う Security Interest Group の Charter が新規公開された。
2. [**コミュニティ Charter の URL 体系再編**](../latest-detail/2026-06-16.md#2-コミュニティ-charter-の-url-体系再編):  
...
- [**Security Charter**](../latest-detail/2026-06-16.md#1-mcp-security-interest-group-の新設) ([MCP Docs](https://modelcontextprotocol.io/community/interest-groups/security)):  
