...
1. [**Mcp-Param ヘッダの構築規則を厳格化**](../latest-detail/2026-06-30.md#1-mcp-param-ヘッダの構築規則を厳格化):  
  クライアントは最新の `inputSchema` を用いて `Mcp-Param-*` ヘッダを構築することが MUST 化され、サーバー拒否のトリガーに「必須ヘッダの欠落」に加え「本文との不一致」が明記された。
2. [**Base64 プレフィックスの大小文字扱いを厳格化**](../latest-detail/2026-06-30.md#2-base64-プレフィックスの大小文字扱いを厳格化):  
...
- 前回サマリ(ライト版): [../latest/2026-06-26.md](../latest/2026-06-26.md)
- 前回サマリ(詳細版): [../latest-detail/2026-06-26.md](../latest-detail/2026-06-26.md)
