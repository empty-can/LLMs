...
1. [**Claude for Desktop の Linux 対応がサーバー構築チュートリアルに反映**](../latest-detail/2026-08-15.md#1-claude-for-desktop-の-linux-対応がサーバー構築チュートリアルに反映):  
...
- [**Build an MCP server**](../latest-detail/2026-08-15.md#1-build-an-mcp-server) ([MCP Docs](https://modelcontextprotocol.io/docs/2026-07-28/develop/build-server)):  
