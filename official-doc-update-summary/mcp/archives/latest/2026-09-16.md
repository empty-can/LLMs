...
1. [**SEP-2640 が参照する Working Group 資料 5 件のリンク先が docs 直下から archive 配下へ移動**](../latest-detail/2026-09-16.md#1-sep-2640-が参照する-working-group-資料-5-件のリンク先が-docs-直下から-archive-配下へ移動):  
