...
1. [**Resources を双方向化する Filesystems Working Group の charter が追加**](../latest-detail/2026-09-08.md#1-resources-を双方向化する-filesystems-working-group-の-charter-が追加):  
...
- [**Filesystems Charter**](../latest-detail/2026-09-08.md#1-filesystems-charter) ([MCP Docs](https://modelcontextprotocol.io/community/working-groups/filesystems)):  
