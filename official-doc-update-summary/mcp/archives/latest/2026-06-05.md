...
1. [**MCP 認可 Interest Group 憲章の新設**](../latest-detail/2026-06-05.md#1-mcp-認可-interest-group-憲章の新設):  
  OAuth 2.1 ベースの認可仕様の実運用課題を収集し、検証済みの問題を Working Group へ橋渡しするための Interest Group（IG）設立憲章。スコープ・体制・配下の認可 Working Group 一覧を定義する。

## 新規追加されたページ

- [**Authorization Charter**](../latest-detail/2026-06-05.md#1-authorization-charter) ([modelcontextprotocol.io](https://modelcontextprotocol.io/community/auth/charter)):  
