...
1. [**MCP Tasks 拡張の状態通知メソッド変更**](../latest-detail/2026-06-07.md#1-mcp-tasks-拡張の状態通知メソッド変更):  
...
2. [**拡張機構の正式化と SEP Extensions Track 種別の追加**](../latest-detail/2026-06-07.md#2-拡張機構の正式化と-sep-extensions-track-種別の追加):  
...
3. [**機能ライフサイクルと SDK ガバナンスの整備**](../latest-detail/2026-06-07.md#3-機能ライフサイクルと-sdk-ガバナンスの整備):  
