...
1. [**v2.1.270 は 1 項目だけで、読み取り専用 git の権限プロンプトを取り消した**](./latest-detail.md#1-v21270-は-1-項目だけで読み取り専用-git-の権限プロンプトを取り消した):  
...
2. [**`goal` ページの見出しが 2 件先行して届き、持ち越しがゼロから積み直された**](./latest-detail.md#2-goal-ページの見出しが-2-件先行して届き持ち越しがゼロから積み直された):  
