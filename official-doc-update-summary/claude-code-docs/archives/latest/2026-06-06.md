...
- [**SDK のサブエージェント**](../latest-detail/2026-06-06.md#2-sdk-のサブエージェント定義再開の刷新) ([日本語](https://code.claude.com/docs/ja/agent-sdk/subagents) / [English](https://code.claude.com/docs/en/agent-sdk/subagents)):  
