...
- 「Permissions」ページに、トランスクリプトや権限ダイアログに表示されるツールのラベルが正規名と異なりうる旨の説明が追加された（例: 表示が `Stop Task` のツールの正規名は `TaskStop`）。権限ルールと hook マッチャーは正規名のみにマッチするため、`Stop Task` と書いたルールはマッチしない。 — [日本語](https://code.claude.com/docs/ja/permissions#tool-name-wildcards) / [English](https://code.claude.com/docs/en/permissions#tool-name-wildcards)
...
- [**2026年06月01日～05日(Week 23)**](../latest-detail/2026-06-15.md#2026年06月01日05日week-23) ([日本語](https://code.claude.com/docs/ja/whats-new/2026-w23) / [English](https://code.claude.com/docs/en/whats-new/2026-w23)):  
...
- [**2026年06月08日～12日(Week 24)**](../latest-detail/2026-06-15.md#2026年06月08日12日week-24) ([日本語](https://code.claude.com/docs/ja/whats-new/2026-w24) / [English](https://code.claude.com/docs/en/whats-new/2026-w24)):  
