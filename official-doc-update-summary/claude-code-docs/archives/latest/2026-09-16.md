...
1. [**クラウド用語への改称が本文へ一斉に着地し、118 ページが動いた**](../latest-detail/2026-09-16.md#1-クラウド用語への改称が本文へ一斉に着地し118-ページが動いた):  
...
2. [**auto モードのネットワーク承認がコマンドごとの許可ドメインに置き換わった**](../latest-detail/2026-09-16.md#2-auto-モードのネットワーク承認がコマンドごとの許可ドメインに置き換わった):  
...
3. [**予告されていた 6 見出しが全て着地し、`errors` に 6 節が新設された**](../latest-detail/2026-09-16.md#3-予告されていた-6-見出しが全て着地しerrors-に-6-節が新設された):  
...
4. [**v2.1.273 が 64 項目で着地した**](../latest-detail/2026-09-16.md#4-v21273-が-64-項目で着地した):  
...
5. [**changelog が先に告知していた 3 つの設定が本文に書き下ろされた**](../latest-detail/2026-09-16.md#5-changelog-が先に告知していた-3-つの設定が本文に書き下ろされた):  
...
- [**Agent SDK の設定オプションが 1 ページにまとまった**](../latest-detail/2026-09-16.md#1-agent-sdk-の設定オプションが-1-ページにまとまった) ([日本語](https://code.claude.com/docs/ja/agent-sdk/configuration) / [English](https://code.claude.com/docs/en/agent-sdk/configuration)):  
...
- [**クラウドとローカルの比較表が 2 列に再編された**](../latest-detail/2026-09-16.md#1-クラウドとローカルの比較表が-2-列に再編された) ([English](https://code.claude.com/docs/en/web-quickstart#compare-ways-to-run-claude-code)):  
...
- [**Agent SDK Python リファレンスの変更は実質 2 か所だけだった**](../latest-detail/2026-09-16.md#2-agent-sdk-python-リファレンスの変更は実質-2-か所だけだった) ([English](https://code.claude.com/docs/en/agent-sdk/python#claudeagentoptions)):  
...
- [**Agent SDK TypeScript リファレンスも桁揃えが大半を占めた**](../latest-detail/2026-09-16.md#3-agent-sdk-typescript-リファレンスも桁揃えが大半を占めた) ([English](https://code.claude.com/docs/en/agent-sdk/typescript#applyflagsettings)):  
...
- [**新着情報の索引ページ**](../latest-detail/2026-09-16.md#新着情報の索引ページ) ([日本語](https://code.claude.com/docs/ja/whats-new/index) / [English](https://code.claude.com/docs/en/whats-new/index)):  
...
- [**2026年05月11日～15日(Week 20)**](../latest-detail/2026-09-16.md#2026年05月11日15日week-20) ([日本語](https://code.claude.com/docs/ja/whats-new/2026-w20) / [English](https://code.claude.com/docs/en/whats-new/2026-w20)):  
...
- [**2026年03月30日～04月03日(Week 14)**](../latest-detail/2026-09-16.md#2026年03月30日04月03日week-14) ([日本語](https://code.claude.com/docs/ja/whats-new/2026-w14) / [English](https://code.claude.com/docs/en/whats-new/2026-w14)):  
