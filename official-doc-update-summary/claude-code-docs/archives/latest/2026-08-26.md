...
1. [**Claude がフィードバックの下書きを作る `SendFeedback` ツール**](../latest-detail/2026-08-26.md#1-claude-がフィードバックの下書きを作る-sendfeedback-ツール):  
...
2. [**スピナーのカスタムヒントが ID・クールダウン・優先度・外部ファイルに対応した**](../latest-detail/2026-08-26.md#2-スピナーのカスタムヒントが-idクールダウン優先度外部ファイルに対応した):  
...
3. [**バックグラウンドセッションのターミナルホスト死亡・無応答を検出して再起動できるようになった**](../latest-detail/2026-08-26.md#3-バックグラウンドセッションのターミナルホスト死亡無応答を検出して再起動できるようになった):  
...
4. [**組織の IP 許可リストと `bridge.claudeusercontent.com` のプロキシ egress**](../latest-detail/2026-08-26.md#4-組織の-ip-許可リストと-bridgeclaudeusercontentcom-のプロキシ-egress):  
...
5. [**Team / Enterprise の Claude Code on the web オンボーディングが書き直された**](../latest-detail/2026-08-26.md#5-team--enterprise-の-claude-code-on-the-web-オンボーディングが書き直された):  
...
- [**エラーリファレンス**](../latest-detail/2026-08-26.md#1-エラーリファレンス) ([English](https://code.claude.com/docs/en/errors#find-your-error)):  
  差分 170 行で今回最大。新設セクションが 7 本（うち 3 本は v2.1.247 由来）入り、応答が途中で切れたときの扱いも書き直された。
- [**設定リファレンス**](../latest-detail/2026-08-26.md#2-設定リファレンス) ([English](https://code.claude.com/docs/en/settings-reference#all-settings)):  
  差分 80 行。`spinnerTipsOverride` の全面書き直し（ハイライト 2）と、新キー `feedbackDrafts`（ハイライト 1）の 2 か所でほぼ全てを占める。
- [**ツールリファレンス**](../latest-detail/2026-08-26.md#3-ツールリファレンス) ([English](https://code.claude.com/docs/en/tools-reference#sendfeedback-tool-behavior)):  
