...
1. [**Claude Console による組織レベルのモデル制限**](../latest-detail/2026-06-24.md#1-claude-console-による組織レベルのモデル制限):  
...
2. [**availableModels 許可リストの適用範囲と Default モデル強制**](../latest-detail/2026-06-24.md#2-availablemodels-許可リストの適用範囲と-default-モデル強制):  
...
3. [**sandbox.credentials によるサンドボックスの認証情報保護**](../latest-detail/2026-06-24.md#3-sandboxcredentials-によるサンドボックスの認証情報保護):  
...
4. [**サーバー管理設定の配信条件の明確化**](../latest-detail/2026-06-24.md#4-サーバー管理設定の配信条件の明確化):  
...
- [**LLM ゲートウェイへの接続**](../latest-detail/2026-06-24.md#1-llm-ゲートウェイへの接続) ([日本語](https://code.claude.com/docs/ja/llm-gateway-connect) / [English](https://code.claude.com/docs/en/llm-gateway-connect)):  
...
- [**ゲートウェイプロトコルリファレンス**](../latest-detail/2026-06-24.md#2-ゲートウェイプロトコルリファレンス) ([日本語](https://code.claude.com/docs/ja/llm-gateway-protocol) / [English](https://code.claude.com/docs/en/llm-gateway-protocol)):  
  Claude Code と LLM ゲートウェイ間の API 契約。転送すべきエンドポイント・ヘッダー・ボディフィールド、フィールド除去時の機能縮退、コスト追跡用の属性ヘッダー、モデルディスカバリーを規定する。
- [**組織向け LLM ゲートウェイの展開**](../latest-detail/2026-06-24.md#3-組織向け-llm-ゲートウェイの展開) ([日本語](https://code.claude.com/docs/ja/llm-gateway-rollout) / [English](https://code.claude.com/docs/en/llm-gateway-rollout)):  
...
- 前回サマリ(ライト版): [../latest/2026-06-23.md](../latest/2026-06-23.md)
- 前回サマリ(詳細版): [../latest-detail/2026-06-23.md](../latest-detail/2026-06-23.md)
