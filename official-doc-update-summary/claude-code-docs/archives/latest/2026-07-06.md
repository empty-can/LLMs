...
1. [**動的ワークフローのサイズガイドライン設定**](../latest-detail/2026-07-06.md#1-動的ワークフローのサイズガイドライン設定):  
...
2. [**ダウンロード切断エラーの新規リファレンスと自動リトライ**](../latest-detail/2026-07-06.md#2-ダウンロード切断エラーの新規リファレンスと自動リトライ):  
...
3. [**GHES プラグインマーケットプレイスの登録方式と認証要件の刷新**](../latest-detail/2026-07-06.md#3-ghes-プラグインマーケットプレイスの登録方式と認証要件の刷新):  
...
4. [**ワークフロー由来エージェントの OpenTelemetry 属性追加**](../latest-detail/2026-07-06.md#4-ワークフロー由来エージェントの-opentelemetry-属性追加):  
