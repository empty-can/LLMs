...
1. [**出力スタイルの変更がキャッシュ無効化の側へ移った**](../latest-detail/2026-09-08.md#1-出力スタイルの変更がキャッシュ無効化の側へ移った):  
...
2. [**スキルの読み込み先を選ぶ節が新設され配下が全面改称された**](../latest-detail/2026-09-08.md#2-スキルの読み込み先を選ぶ節が新設され配下が全面改称された):  
...
3. [**設定ページと設定リファレンスのタイトルが入れ替わった**](../latest-detail/2026-09-08.md#3-設定ページと設定リファレンスのタイトルが入れ替わった):  
...
4. [**セッションデータの削除の節が新設された**](../latest-detail/2026-09-08.md#4-セッションデータの削除の節が新設された):  
