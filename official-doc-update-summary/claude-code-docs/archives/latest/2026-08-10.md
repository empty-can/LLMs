...
- [**ツールリファレンス**](../latest-detail/2026-08-10.md#3-ツールリファレンス) ([日本語](https://code.claude.com/docs/ja/tools-reference) / [English](https://code.claude.com/docs/en/tools-reference)):  
...
- [**SDK のスラッシュコマンド**](../latest-detail/2026-08-10.md#7-sdk-のスラッシュコマンド) ([日本語](https://code.claude.com/docs/ja/agent-sdk/slash-commands) / [English](https://code.claude.com/docs/en/agent-sdk/slash-commands)):  
...
- 権限モードのページに、auto モードの分類器が `SendMessage` で他のエージェントへ送るメッセージも配信前にレビューする旨が明記されました。プレーンなメッセージと構造化メッセージの両方が対象で、auto モードだけでなく分類器がコマンドをレビューするプランモードでも働きます（挙動自体は v2.1.222 以降。同趣旨の記述はツールリファレンスの `SendMessage` 行から削除され、こちらへ集約されました）— [日本語](https://code.claude.com/docs/ja/permission-modes#eliminate-prompts-with-auto-mode) / [English](https://code.claude.com/docs/en/permission-modes#eliminate-prompts-with-auto-mode)
...
- プラグイン依存のバージョン制約について、タグを探すリポジトリが明確化されました。`github` / `url` / `git-subdir` ソースではプラグイン自身のリポジトリ、マーケットプレイスが相対パスで参照するプラグインではマーケットプレイスのリポジトリです。プラグイン自身のリポジトリに条件を満たすタグが無い場合はインストールが失敗し、相対パス参照の場合はマーケットプレイスの現在のコピーを入れて読み込み時に制約を確認します。タグ解決が効かないソースとして `archive` も追記されました — [日本語](https://code.claude.com/docs/ja/plugin-dependencies#tag-plugin-releases-for-version-resolution) / [English](https://code.claude.com/docs/en/plugin-dependencies#tag-plugin-releases-for-version-resolution)
...
- Claude Tag へのリンク先が、ドキュメントの概要ページから製品ページ（`claude.com/product/tag`）に変更されました。Claude Tag ページ本体と、Claude Code in Slack ページの告知の両方が対象です — [日本語](https://code.claude.com/docs/ja/claude-tag) / [English](https://code.claude.com/docs/en/claude-tag)
...
- [**2026年07月20日～24日(Week 30)**](../latest-detail/2026-08-10.md#2026年07月20日24日week-30) ([日本語](https://code.claude.com/docs/ja/whats-new/2026-w30) / [English](https://code.claude.com/docs/en/whats-new/2026-w30)):  
...
- [**2026年08月03日～07日(Week 32)**](../latest-detail/2026-08-10.md#2026年08月03日07日week-32) ([日本語](https://code.claude.com/docs/ja/whats-new/2026-w32) / [English](https://code.claude.com/docs/en/whats-new/2026-w32)):  
