...
1. [**プラグインのドキュメントが独立した「Plugins」セクションに組み替えられた**](../latest-detail/2026-09-24.md#1-プラグインのドキュメントが独立したpluginsセクションに組み替えられた):  
...
2. [**AGENTS.md が Bedrock やテレメトリ無効のセッションでも読まれるようになった**](../latest-detail/2026-09-24.md#2-agentsmd-が-bedrock-やテレメトリ無効のセッションでも読まれるようになった):  
...
3. [**v2.1.281 の 176 項目が積まれた**](../latest-detail/2026-09-24.md#3-v21281-の-176-項目が積まれた):  
...
4. [**クラウドセッションの「research preview」表記が外れた**](../latest-detail/2026-09-24.md#4-クラウドセッションのresearch-preview表記が外れた):  
...
- [**新しいプラグインページ 20 件は、索引と見出しマップにだけ載り、本文はまだ届いていない**](../latest-detail/2026-09-24.md#1-新しいプラグインページ-20-件は索引と見出しマップにだけ載り本文はまだ届いていない) ([English](https://code.claude.com/docs/en/plugins/overview)):  
