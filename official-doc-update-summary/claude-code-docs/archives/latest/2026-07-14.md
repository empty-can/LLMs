...
1. [**Edit ツールの read-before-edit 制約が緩和**](../latest-detail/2026-07-14.md#1-edit-ツールの-read-before-edit-制約が緩和):  
...
2. [**Read deny ルールが Edit ツールもブロック**](../latest-detail/2026-07-14.md#2-read-deny-ルールが-edit-ツールもブロック):  
...
3. [**Remote Control のトランスクリプトが Anthropic サーバーに保存**](../latest-detail/2026-07-14.md#3-remote-control-のトランスクリプトが-anthropic-サーバーに保存):  
...
4. [**Amazon Bedrock ストリーミングの content-type ガード**](../latest-detail/2026-07-14.md#4-amazon-bedrock-ストリーミングの-content-type-ガード):  
...
5. [**バックグラウンドセッションの worktree がコミットを破棄しなくなった**](../latest-detail/2026-07-14.md#5-バックグラウンドセッションの-worktree-がコミットを破棄しなくなった):  
...
- [**エラーリファレンス**](../latest-detail/2026-07-14.md#1-エラーリファレンス) ([日本語](https://code.claude.com/docs/ja/errors) / [English](https://code.claude.com/docs/en/errors)):  
...
- [**エージェントビュー**](../latest-detail/2026-07-14.md#2-エージェントビュー) ([日本語](https://code.claude.com/docs/ja/agent-view) / [English](https://code.claude.com/docs/en/agent-view)):  
...
- [**ツールリファレンス**](../latest-detail/2026-07-14.md#3-ツールリファレンス) ([日本語](https://code.claude.com/docs/ja/tools-reference) / [English](https://code.claude.com/docs/en/tools-reference)):  
...
- [**プラグインリファレンス**](../latest-detail/2026-07-14.md#4-プラグインリファレンス) ([日本語](https://code.claude.com/docs/ja/plugins-reference) / [English](https://code.claude.com/docs/en/plugins-reference)):  
  `${user_config.*}` がシェル経由のフィールドで拒否される仕様が表に再構成され（各フィールドの代替手段つき）、`${CLAUDE_PLUGIN_ROOT}` などパスプレースホルダの置換対象がコンポーネント別・サーバー型別の表に整理された。
- [**権限モード**](../latest-detail/2026-07-14.md#5-権限モード) ([日本語](https://code.claude.com/docs/ja/permission-modes) / [English](https://code.claude.com/docs/en/permission-modes)):  
