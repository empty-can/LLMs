...
1. [**LLM ゲートウェイ ドキュメントの再編**](../latest-detail/2026-06-25.md#1-llm-ゲートウェイ-ドキュメントの再編):  
...
2. [**Remote Control の Trusted Devices**](../latest-detail/2026-06-25.md#2-remote-control-の-trusted-devices):  
...
3. [**フック matcher のカンマ区切り対応**](../latest-detail/2026-06-25.md#3-フック-matcher-のカンマ区切り対応):  
...
- [**機能の利用可能性**](../latest-detail/2026-06-25.md#1-機能の利用可能性) ([日本語](https://code.claude.com/docs/ja/feature-availability) / [English](https://code.claude.com/docs/en/feature-availability)):  
