...
- [日本語](https://code.claude.com/docs/ja/llm-gateway-protocol) / [Claude Code ゲートウェイ互換性ガイド - Claude Code Docs (English)](https://code.claude.com/docs/en/llm-gateway-protocol)
