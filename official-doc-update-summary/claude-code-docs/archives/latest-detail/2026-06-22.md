...
- [日本語](https://code.claude.com/docs/ja/plugin-relevance) / [Recommend plugins for your org - Claude Code Docs (English)](https://code.claude.com/docs/en/plugin-relevance)
...
- [日本語](https://code.claude.com/docs/ja/ultrareview) / [Find bugs with ultrareview - Claude Code Docs (English)](https://code.claude.com/docs/en/ultrareview)

## 新規追加されたページ

<!-- light:new-pages:start -->
- [**Recommend plugins for your org（plugin-relevance）**](#1-プラグイン推薦ページ-plugin-relevance-の新設) ([日本語](https://code.claude.com/docs/ja/plugin-relevance) / [English](https://code.claude.com/docs/en/plugin-relevance)):  
