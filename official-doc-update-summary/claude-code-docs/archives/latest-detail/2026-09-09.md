...
- [日本語](https://code.claude.com/docs/ja/managed-mcp) / [Control MCP server access for your organization - Claude Code Docs (English)](https://code.claude.com/docs/en/managed-mcp)
