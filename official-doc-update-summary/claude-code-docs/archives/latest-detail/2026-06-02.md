...
- [モデル設定 - Claude Code Docs (日本語)](https://code.claude.com/docs/ja/model-config#available-models)
...
- [日本語](https://code.claude.com/docs/ja/workflows) / [Orchestrate subagents at scale with dynamic workflows - Claude Code Docs (English)](https://code.claude.com/docs/en/workflows)
...
- [日本語](https://code.claude.com/docs/ja/security-guidance) / [Catch security issues as Claude writes code - Claude Code Docs (English)](https://code.claude.com/docs/en/security-guidance)
...
- [高速モードで応答を高速化する - Claude Code Docs (日本語)](https://code.claude.com/docs/ja/fast-mode#understand-the-cost-tradeoff)
- [Speed up responses with fast mode - Claude Code Docs (English)](https://code.claude.com/docs/en/fast-mode#understand-the-cost-tradeoff)
...
- [パーミッションモードを選択する - Claude Code Docs (日本語)](https://code.claude.com/docs/ja/permission-modes#eliminate-prompts-with-auto-mode)
...
- [日本語](https://code.claude.com/docs/ja/whats-new/2026-w21) / [Week 21 · May 18–22, 2026 - Claude Code Docs (English)](https://code.claude.com/docs/en/whats-new/2026-w21)
...
- [日本語](https://code.claude.com/docs/ja/whats-new/2026-w22) / [Week 22 · May 25–29, 2026 - Claude Code Docs (English)](https://code.claude.com/docs/en/whats-new/2026-w22)
