...
- [日本語](https://code.claude.com/docs/ja/artifacts) / [Share session output as artifacts - Claude Code Docs (English)](https://code.claude.com/docs/en/artifacts)
...
- [**アーティファクトページ（artifacts）**](#1-アーティファクトページartifacts) ([日本語](https://code.claude.com/docs/ja/artifacts) / [English](https://code.claude.com/docs/en/artifacts)):  
