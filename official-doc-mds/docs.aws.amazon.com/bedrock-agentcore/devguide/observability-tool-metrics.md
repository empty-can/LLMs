...
**Topics**
+ [Observability tools metrics](#observability-tools-metrics-one)
+ [Resource usage metrics and logs](#observability-tools-resource-usage-metrics-logs)
+ [Provided span data](#observability-tools-span-data)
+ [Application log data](#observability-tools-application-log-data)
