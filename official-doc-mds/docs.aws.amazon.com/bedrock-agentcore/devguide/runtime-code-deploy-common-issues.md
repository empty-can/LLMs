...
<a name="runtime-code-deploy-common-issues"></a>
...
1. Use compatible language version (check AgentCore Runtime supported versions).

1. Verify ZIP structure contains proper entry points and dependencies.

1. Rebuild packages on compatible runtime environment.
...
<a name="arm64-binary-incompatibility"></a>
...
<a name="node-incompatible-engines"></a>
...
<a name="node-missing-otel-package"></a>
