...
+ [Option 1: Managed VPC resources](#lattice-vpc-egress-managed-lattice)
+ [Option 2: Self-managed Lattice resources](#lattice-vpc-egress-self-managed-lattice)
+ [Route traffic through an intermediate domain](#lattice-vpc-egress-routing-domain)
 ...
 **AgentCore Identity**   
AgentCore Identity supports private endpoints for connecting to VPC hosted OAuth 2.0 identity providers for both inbound JWT authorization and outbound OAuth credential providers. For details, see [Connect to private identity providers](identity-private-idp.md).
