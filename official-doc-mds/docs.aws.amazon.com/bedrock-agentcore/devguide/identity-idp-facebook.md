...
1. In the navigation bar, choose **App Settings** , and then choose **Basic**.
...
1. Leave the **Valid OAuth Redirect URIs** field empty for now — you will add the unique callback URL in Step 3.
