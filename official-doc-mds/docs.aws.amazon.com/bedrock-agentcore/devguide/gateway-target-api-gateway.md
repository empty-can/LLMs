...
**Topics**
+ [Key considerations and limitations](#gateway-target-api-gateway-limitations)
+ [API Gateway Tool Configuration](#gateway-target-api-gateway-configuration)
+ [API Gateway export](#gateway-target-api-gateway-export)
+ [Supported outbound authorization methods for an API Gateway API](#gateway-target-api-gateway-outbound)
