...
1. Enable and configure the OAuth settings for the application. Leave the callback URL field empty for now — you will add the unique callback URL in Step 3.
