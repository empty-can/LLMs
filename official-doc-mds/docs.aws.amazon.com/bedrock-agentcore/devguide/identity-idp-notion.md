...
1. On the integration details page, open the **OAuth Domain & URIs** section. Leave the redirect URI list empty for now — you will add the unique callback URL in Step 3.
