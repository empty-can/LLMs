...
<a name="API_agent_OpenSearchServerlessFieldMapping"></a>

Contains the names of the fields to which to map information about the vector store.

## Contents
<a name="API_agent_OpenSearchServerlessFieldMapping_Contents"></a>
...
## See Also
<a name="API_agent_OpenSearchServerlessFieldMapping_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/bedrock-agent-2023-06-05/OpenSearchServerlessFieldMapping) 
