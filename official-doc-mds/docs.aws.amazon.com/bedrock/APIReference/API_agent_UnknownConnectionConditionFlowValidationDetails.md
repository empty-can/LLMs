...
<a name="API_agent_UnknownConnectionConditionFlowValidationDetails"></a>

Details about an unknown condition for a connection.

## Contents
<a name="API_agent_UnknownConnectionConditionFlowValidationDetails_Contents"></a>
...
## See Also
<a name="API_agent_UnknownConnectionConditionFlowValidationDetails_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/bedrock-agent-2023-06-05/UnknownConnectionConditionFlowValidationDetails) 
