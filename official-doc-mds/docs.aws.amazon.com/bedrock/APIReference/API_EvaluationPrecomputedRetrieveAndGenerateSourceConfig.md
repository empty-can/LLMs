...
<a name="API_EvaluationPrecomputedRetrieveAndGenerateSourceConfig"></a>
...
## Contents
<a name="API_EvaluationPrecomputedRetrieveAndGenerateSourceConfig_Contents"></a>
...
## See Also
<a name="API_EvaluationPrecomputedRetrieveAndGenerateSourceConfig_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/bedrock-2023-04-20/EvaluationPrecomputedRetrieveAndGenerateSourceConfig) 
