...
<a name="API_agent_MismatchedNodeInputTypeFlowValidationDetails"></a>

Details about mismatched input data types in a node.

## Contents
<a name="API_agent_MismatchedNodeInputTypeFlowValidationDetails_Contents"></a>
...
## See Also
<a name="API_agent_MismatchedNodeInputTypeFlowValidationDetails_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/bedrock-agent-2023-06-05/MismatchedNodeInputTypeFlowValidationDetails) 
