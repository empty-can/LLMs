...
# OptimizedPrompt
<a name="API_agent-runtime_OptimizedPrompt"></a>

Contains information about the optimized prompt.

## Contents
<a name="API_agent-runtime_OptimizedPrompt_Contents"></a>
...
## See Also
<a name="API_agent-runtime_OptimizedPrompt_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/bedrock-agent-runtime-2023-07-26/OptimizedPrompt) 
