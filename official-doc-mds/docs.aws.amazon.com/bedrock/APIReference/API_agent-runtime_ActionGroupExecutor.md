...
# ActionGroupExecutor
<a name="API_agent-runtime_ActionGroupExecutor"></a>

 Contains details about the Lambda function containing the business logic that is carried out upon invoking the action or the custom control method for handling the information elicited from the user. 

## Contents
<a name="API_agent-runtime_ActionGroupExecutor_Contents"></a>
...
## See Also
<a name="API_agent-runtime_ActionGroupExecutor_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/bedrock-agent-runtime-2023-07-26/ActionGroupExecutor) 
