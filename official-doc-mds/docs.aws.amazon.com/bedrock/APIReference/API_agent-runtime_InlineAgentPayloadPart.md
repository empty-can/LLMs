...
<a name="API_agent-runtime_InlineAgentPayloadPart"></a>

Contains a part of an agent response and citations for it. 

## Contents
<a name="API_agent-runtime_InlineAgentPayloadPart_Contents"></a>
...
## See Also
<a name="API_agent-runtime_InlineAgentPayloadPart_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/bedrock-agent-runtime-2023-07-26/InlineAgentPayloadPart) 
