...
<a name="API_agent_CyclicConnectionFlowValidationDetails"></a>

Details about a cyclic connection detected in the flow.

## Contents
<a name="API_agent_CyclicConnectionFlowValidationDetails_Contents"></a>
...
## See Also
<a name="API_agent_CyclicConnectionFlowValidationDetails_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/bedrock-agent-2023-06-05/CyclicConnectionFlowValidationDetails) 
