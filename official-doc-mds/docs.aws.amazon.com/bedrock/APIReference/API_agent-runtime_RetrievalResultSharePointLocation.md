...
<a name="API_agent-runtime_RetrievalResultSharePointLocation"></a>

The SharePoint data source location.

## Contents
<a name="API_agent-runtime_RetrievalResultSharePointLocation_Contents"></a>
...
## See Also
<a name="API_agent-runtime_RetrievalResultSharePointLocation_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/bedrock-agent-runtime-2023-07-26/RetrievalResultSharePointLocation) 
