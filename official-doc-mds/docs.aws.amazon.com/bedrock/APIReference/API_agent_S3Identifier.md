...
# S3Identifier
<a name="API_agent_S3Identifier"></a>

The identifier information for an Amazon S3 bucket.

## Contents
<a name="API_agent_S3Identifier_Contents"></a>
...
## See Also
<a name="API_agent_S3Identifier_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/bedrock-agent-2023-06-05/S3Identifier) 
