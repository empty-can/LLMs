...
# ByteContentDoc
<a name="API_agent-runtime_ByteContentDoc"></a>

This property contains the document to chat with, along with its attributes.

## Contents
<a name="API_agent-runtime_ByteContentDoc_Contents"></a>
...
## See Also
<a name="API_agent-runtime_ByteContentDoc_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/bedrock-agent-runtime-2023-07-26/ByteContentDoc) 
