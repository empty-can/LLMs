...
<a name="API_GuardrailContextualGroundingFilter"></a>

The details for the guardrails contextual grounding filter.

## Contents
<a name="API_GuardrailContextualGroundingFilter_Contents"></a>
...
## See Also
<a name="API_GuardrailContextualGroundingFilter_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/bedrock-2023-04-20/GuardrailContextualGroundingFilter) 
