...
<a name="API_agent-runtime_NodeExecutionContent"></a>
...
## Contents
<a name="API_agent-runtime_NodeExecutionContent_Contents"></a>
...
## See Also
<a name="API_agent-runtime_NodeExecutionContent_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/bedrock-agent-runtime-2023-07-26/NodeExecutionContent) 
