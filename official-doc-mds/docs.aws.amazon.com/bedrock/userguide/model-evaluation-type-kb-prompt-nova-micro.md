...
# Amazon Nova Micro
<a name="model-evaluation-type-kb-prompt-nova-micro"></a>

Prompts used with Amazon Nova Micro.

## Logical coherence
<a name="prompt-kb-nova-micro-logical-coherence"></a>
...
You are given a question, a response from LLM, and potential chat histories. Your task is to check if the arguments presented in the response follow logically from one another, regardless of the correctness or completeness to the question.
...
2. Identify any logic gaps or errors in reasoning within the respons:
- Does the response draw false conclusions from its own stated information?
- Does it make "logical leaps" by skipping steps in an argument?
- Are there instances where you think, "this does not follow from that" or "these two things cannot be true at the same time" within the response?

3. Evaluate the soundness of the reasoning, not the soundness of the claims:
- Take the premises stated in the response as the basis for argument, even if they are not true or relevant to the question.
- Evaluate the logical coherence of the response as if its premises were true.

4. Focus solely on internal logical coherence:
- Ignore whether the response actually answers the question or is relevant to it.
- A response that is completely off-topic but internally logically coherent should receive a high rating.
- A response that perfectly answers the question but has internal logical flaws should receive a lower rating.

5. Special consideration for "not enough information" responses:
- If the response states that there is not enough information to address the question, do not penalize this.
- Such responses should be rated as "Yes" for logical coherence, as long as they don't contain internal contradictions or flawed reasoning.
...
```
{"properties": {"reasoning": {"description": "step by step reasoning to derive the final answer", "title": "Reasoning", "type": "string"}, "answer": {"description": "answer should be one of `Not applicable`, `Not at all`, `Not generally`, `Neutral/Mixed`, `Generally yes`, `Yes`", "enum": ["Not applicable", "Not at all", "Not generally", "Neutral/Mixed", "Generally yes", "Yes"], "title": "Answer", "type": "string"}}, "required": ["reasoning", "answer"]}
```
...
### Score mapping
<a name="prompt-kb-nova-micro-logical-coherence-score-mapping"></a>
...
## Helpfulness
<a name="prompt-kb-nova-micro-helpfulness"></a>
...
### Score mapping
<a name="prompt-kb-nova-micro-helpfulness-score-mapping"></a>
+ **above and beyond**: `5`
+ **very helpful**: `4`
+ **somewhat helpful**: `3`
...
## Faithfulness
<a name="prompt-kb-nova-micro-faithfulness"></a>
...
### Score mapping
<a name="prompt-kb-nova-micro-faithfulness-score-mapping"></a>
...
<a name="prompt-kb-nova-micro-grounded-completeness"></a>
...
### Score mapping
<a name="prompt-kb-nova-micro-grounded-completeness-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
<a name="prompt-kb-nova-micro-ungrounded-completeness"></a>
...
### Score mapping
<a name="prompt-kb-nova-micro-ungrounded-completeness-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
<a name="prompt-kb-nova-micro-grounded-correctness"></a>
...
### Score mapping
<a name="prompt-kb-nova-micro-grounded-correctness-score-mapping"></a>
...
<a name="prompt-kb-nova-micro-ungrounded-correctness"></a>
...
### Score mapping
<a name="prompt-kb-nova-micro-ungrounded-correctness-score-mapping"></a>
...
## Context coverage
<a name="prompt-kb-nova-micro-context-coverage"></a>
...
### Score mapping
<a name="prompt-kb-nova-micro-context-coverage-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
## Context relevance
<a name="prompt-kb-nova-micro-context-relevance"></a>

*Context relevance* – Evaluates whether the retrieved contexts are relevant to the question. Responses are graded on a 3-point Likert scale, and then normalized in the output and the job's report card. The `{{chat_history}}` contains the conversation history, the `{{prompt}}` will contain the prompt sent to the generator from your dataset, and the `{{context}}` contains the retrieved context passages.
...
### Score mapping
<a name="prompt-kb-nova-micro-context-relevance-score-mapping"></a>
+ **No**: `0`
+ **Maybe**: `1`
+ **Yes**: `2`

## Citation precision
<a name="prompt-kb-nova-micro-citation-precision"></a>
...
### Score mapping
<a name="prompt-kb-nova-micro-citation-precision-score-mapping"></a>
+ **No**: `0`
+ **Yes**: `1`

## Citation coverage
<a name="prompt-kb-nova-micro-citation-coverage"></a>
...
### Score mapping
<a name="prompt-kb-nova-micro-citation-coverage-score-mapping"></a>
+ **none is faithful**: `0`
+ **some is faithful**: `1`
...
## Harmfulness
<a name="prompt-kb-nova-micro-rai-harmfulness"></a>
...
### Score mapping
<a name="prompt-kb-nova-micro-rai-harmfulness-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`

## Stereotyping
<a name="prompt-kb-nova-micro-rai-stereotype"></a>
...
### Score mapping
<a name="prompt-kb-nova-micro-rai-stereotype-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`

## Refusal
<a name="prompt-kb-nova-micro-rai-refusal"></a>
...
### Score mapping
<a name="prompt-kb-nova-micro-rai-refusal-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`