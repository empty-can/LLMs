...
# Amazon Nova Premier
<a name="model-evaluation-type-judge-prompt-nova-premier"></a>

Prompts used with Amazon Nova Premier.

## Logical coherence
<a name="prompt-judge-nova-premier-coherence"></a>
...
### Score mapping
<a name="prompt-judge-nova-premier-coherence-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
## Faithfulness
<a name="prompt-judge-nova-premier-faithfulness"></a>
...
### Score mapping
<a name="prompt-judge-nova-premier-faithfulness-score-mapping"></a>
...
<a name="prompt-judge-nova-premier-following-instructions"></a>
...
### Score mapping
<a name="prompt-judge-nova-premier-following-instructions-score-mapping"></a>
+ **Not applicable**: `N/A (no score produced)`
+ **No**: `0`
+ **Yes**: `1`

## Completeness with ground truth
<a name="prompt-judge-nova-premier-grounded-completeness"></a>
...
### Score mapping
<a name="prompt-judge-nova-premier-grounded-completeness-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
<a name="prompt-judge-nova-premier-ungrounded-completeness"></a>
...
### Score mapping
<a name="prompt-judge-nova-premier-ungrounded-completeness-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
<a name="prompt-judge-nova-premier-grounded-correctness"></a>
...
### Score mapping
<a name="prompt-judge-nova-premier-grounded-correctness-score-mapping"></a>
+ **correct**: `2`
+ **partially correct**: `1`
+ **incorrect**: `0`

## Correctness with no ground truth
<a name="prompt-judge-nova-premier-ungrounded-correctness"></a>
...
### Score mapping
<a name="prompt-judge-nova-premier-ungrounded-correctness-score-mapping"></a>
+ **correct**: `2`
+ **partially correct**: `1`
+ **incorrect**: `0`

## Helpfulness
<a name="prompt-judge-nova-premier-helpfulness"></a>
...
### Score mapping
<a name="prompt-judge-nova-premier-helpfulness-score-mapping"></a>
+ **above and beyond**: `6`
+ **very helpful**: `5`
+ **somewhat helpful**: `4`
...
<a name="prompt-judge-nova-premier-professional-style-and-tone"></a>
...
### Score mapping
<a name="prompt-judge-nova-premier-professional-style-and-tone-score-mapping"></a>
+ **not at all**: `0`
+ **not generally**: `1`
+ **neutral/mixed**: `2`
+ **generally yes**: `3`
...
## Readability
<a name="prompt-judge-nova-premier-readability"></a>
...
### Score mapping
<a name="prompt-judge-nova-premier-readability-score-mapping"></a>
+ **unreadable**: `0`
+ **poor readability**: `1`
+ **fair readability**: `2`
+ **good readability**: `3`
...
## Relevance
<a name="prompt-judge-nova-premier-relevance"></a>
...
### Score mapping
<a name="prompt-judge-nova-premier-relevance-score-mapping"></a>
+ **not at all**: `0`
+ **slightly**: `1`
+ **somewhat**: `2`
+ **mostly**: `3`
...
## Stereotyping
<a name="prompt-judge-nova-premier-rai-stereotyping"></a>
...
### Score mapping
<a name="prompt-judge-nova-premier-rai-stereotyping-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`

## Harmfulness
<a name="prompt-judge-nova-premier-rai-harmfulness"></a>
...
### Score mapping
<a name="prompt-judge-nova-premier-rai-harmfulness-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`

## Refusal
<a name="prompt-judge-nova-premier-rai-refusal"></a>
...
### Score mapping
<a name="prompt-judge-nova-premier-rai-refusal-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`