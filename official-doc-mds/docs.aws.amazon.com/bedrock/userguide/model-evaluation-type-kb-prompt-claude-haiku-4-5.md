...
<a name="model-evaluation-type-kb-prompt-claude-haiku-4-5"></a>

Prompts used with Anthropic Claude Haiku 4.5.

## Logical coherence
<a name="prompt-kb-claude-haiku-4-5-logical-coherence"></a>
...
### Score mapping
<a name="prompt-kb-claude-haiku-4-5-logical-coherence-score-mapping"></a>
+ **Not at all**: `0`
+ **Neutral/Mixed**: `1`
+ **Yes**: `2`

## Helpfulness
<a name="prompt-kb-claude-haiku-4-5-helpfulness"></a>
...
### Score mapping
<a name="prompt-kb-claude-haiku-4-5-helpfulness-score-mapping"></a>
+ **above and beyond**: `6`
+ **very helpful**: `5`
+ **somewhat helpful**: `4`
...
## Faithfulness
<a name="prompt-kb-claude-haiku-4-5-faithfulness"></a>

*Faithfulness* – Evaluates whether the response is faithful to the retrieved contexts. Responses are graded on a 5-point Likert scale, and then normalized in the output and the job's report card. The `{{chat_history}}` contains the conversation history, the `{{prompt}}` will contain the prompt sent to the generator from your dataset, the `{{context}}` contains the retrieved context passages, and the `{{prediction}}` is the generator model's responses.
...
### Score mapping
<a name="prompt-kb-claude-haiku-4-5-faithfulness-score-mapping"></a>
...
<a name="prompt-kb-claude-haiku-4-5-grounded-completeness"></a>
...
### Score mapping
<a name="prompt-kb-claude-haiku-4-5-grounded-completeness-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
<a name="prompt-kb-claude-haiku-4-5-ungrounded-completeness"></a>
...
### Score mapping
<a name="prompt-kb-claude-haiku-4-5-ungrounded-completeness-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
<a name="prompt-kb-claude-haiku-4-5-grounded-correctness"></a>
...
### Score mapping
<a name="prompt-kb-claude-haiku-4-5-grounded-correctness-score-mapping"></a>
...
<a name="prompt-kb-claude-haiku-4-5-ungrounded-correctness"></a>
...
### Score mapping
<a name="prompt-kb-claude-haiku-4-5-ungrounded-correctness-score-mapping"></a>
...
## Context coverage
<a name="prompt-kb-claude-haiku-4-5-context-coverage"></a>
...
### Score mapping
<a name="prompt-kb-claude-haiku-4-5-context-coverage-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
## Context relevance
<a name="prompt-kb-claude-haiku-4-5-context-relevance"></a>
...
### Score mapping
<a name="prompt-kb-claude-haiku-4-5-context-relevance-score-mapping"></a>
+ **No**: `0`
+ **Maybe**: `1`
+ **Yes**: `2`

## Citation precision
<a name="prompt-kb-claude-haiku-4-5-citation-precision"></a>
...
### Score mapping
<a name="prompt-kb-claude-haiku-4-5-citation-precision-score-mapping"></a>
+ **No**: `0`
+ **Yes**: `1`

## Citation coverage
<a name="prompt-kb-claude-haiku-4-5-citation-coverage"></a>
...
### Score mapping
<a name="prompt-kb-claude-haiku-4-5-citation-coverage-score-mapping"></a>
+ **none is present in context**: `0`
...
## Harmfulness
<a name="prompt-kb-claude-haiku-4-5-rai-harmfulness"></a>
...
### Score mapping
<a name="prompt-kb-claude-haiku-4-5-rai-harmfulness-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`

## Stereotyping
<a name="prompt-kb-claude-haiku-4-5-rai-stereotype"></a>
...
### Score mapping
<a name="prompt-kb-claude-haiku-4-5-rai-stereotype-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`

## Refusal
<a name="prompt-kb-claude-haiku-4-5-rai-refusal"></a>
...
### Score mapping
<a name="prompt-kb-claude-haiku-4-5-rai-refusal-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`