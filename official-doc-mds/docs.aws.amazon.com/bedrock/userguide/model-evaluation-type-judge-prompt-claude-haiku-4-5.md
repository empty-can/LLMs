...
<a name="model-evaluation-type-judge-prompt-claude-haiku-4-5"></a>

Prompts used with Anthropic Claude Haiku 4.5.

## Logical coherence
<a name="prompt-judge-claude-haiku-4-5-coherence"></a>
...
### Score mapping
<a name="prompt-judge-claude-haiku-4-5-coherence-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
## Faithfulness
<a name="prompt-judge-claude-haiku-4-5-faithfulness"></a>
...
### Score mapping
<a name="prompt-judge-claude-haiku-4-5-faithfulness-score-mapping"></a>
+ **none is faithful**: `0`
+ **some is faithful**: `1`
...
<a name="prompt-judge-claude-haiku-4-5-following-instructions"></a>
...
### Score mapping
<a name="prompt-judge-claude-haiku-4-5-following-instructions-score-mapping"></a>
+ **Not applicable**: `N/A (no score produced)`
+ **No**: `0`
+ **Yes**: `1`

## Completeness with ground truth
<a name="prompt-judge-claude-haiku-4-5-grounded-completeness"></a>
...
### Score mapping
<a name="prompt-judge-claude-haiku-4-5-grounded-completeness-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
<a name="prompt-judge-claude-haiku-4-5-ungrounded-completeness"></a>
...
### Score mapping
<a name="prompt-judge-claude-haiku-4-5-ungrounded-completeness-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
<a name="prompt-judge-claude-haiku-4-5-grounded-correctness"></a>
...
### Score mapping
<a name="prompt-judge-claude-haiku-4-5-grounded-correctness-score-mapping"></a>
+ **correct**: `2`
+ **partially correct**: `1`
+ **incorrect**: `0`

## Correctness with no ground truth
<a name="prompt-judge-claude-haiku-4-5-ungrounded-correctness"></a>
...
### Score mapping
<a name="prompt-judge-claude-haiku-4-5-ungrounded-correctness-score-mapping"></a>
+ **correct**: `2`
+ **partially correct**: `1`
+ **incorrect**: `0`

## Helpfulness
<a name="prompt-judge-claude-haiku-4-5-helpfulness"></a>
...
### Score mapping
<a name="prompt-judge-claude-haiku-4-5-helpfulness-score-mapping"></a>
+ **above and beyond**: `6`
+ **very helpful**: `5`
+ **somewhat helpful**: `4`
...
<a name="prompt-judge-claude-haiku-4-5-professional-style-and-tone"></a>
...
### Score mapping
<a name="prompt-judge-claude-haiku-4-5-professional-style-and-tone-score-mapping"></a>
+ **not at all**: `0`
+ **not generally**: `1`
+ **neutral/mixed**: `2`
+ **generally yes**: `3`
...
## Readability
<a name="prompt-judge-claude-haiku-4-5-readability"></a>
...
### Score mapping
<a name="prompt-judge-claude-haiku-4-5-readability-score-mapping"></a>
+ **unreadable**: `0`
+ **poor readability**: `1`
+ **fair readability**: `2`
+ **good readability**: `3`
...
## Relevance
<a name="prompt-judge-claude-haiku-4-5-relevance"></a>
...
### Score mapping
<a name="prompt-judge-claude-haiku-4-5-relevance-score-mapping"></a>
+ **not at all**: `0`
+ **slightly**: `1`
+ **somewhat**: `2`
+ **mostly**: `3`
...
## Stereotyping
<a name="prompt-judge-claude-haiku-4-5-rai-stereotyping"></a>
...
### Score mapping
<a name="prompt-judge-claude-haiku-4-5-rai-stereotyping-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`

## Harmfulness
<a name="prompt-judge-claude-haiku-4-5-rai-harmfulness"></a>
...
### Score mapping
<a name="prompt-judge-claude-haiku-4-5-rai-harmfulness-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`

## Refusal
<a name="prompt-judge-claude-haiku-4-5-rai-refusal"></a>
...
### Score mapping
<a name="prompt-judge-claude-haiku-4-5-rai-refusal-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`