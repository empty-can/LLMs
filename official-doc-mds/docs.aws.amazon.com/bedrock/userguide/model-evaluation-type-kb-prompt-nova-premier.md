...
# Amazon Nova Premier
<a name="model-evaluation-type-kb-prompt-nova-premier"></a>

Prompts used with Amazon Nova Premier.

## Logical coherence
<a name="prompt-kb-nova-premier-logical-coherence"></a>
...
### Score mapping
<a name="prompt-kb-nova-premier-logical-coherence-score-mapping"></a>
...
## Helpfulness
<a name="prompt-kb-nova-premier-helpfulness"></a>
...
### Score mapping
<a name="prompt-kb-nova-premier-helpfulness-score-mapping"></a>
+ **above and beyond**: `6`
+ **very helpful**: `5`
+ **somewhat helpful**: `4`
...
## Faithfulness
<a name="prompt-kb-nova-premier-faithfulness"></a>
...
### Score mapping
<a name="prompt-kb-nova-premier-faithfulness-score-mapping"></a>
...
<a name="prompt-kb-nova-premier-grounded-completeness"></a>
...
### Score mapping
<a name="prompt-kb-nova-premier-grounded-completeness-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
<a name="prompt-kb-nova-premier-ungrounded-completeness"></a>
...
### Score mapping
<a name="prompt-kb-nova-premier-ungrounded-completeness-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
<a name="prompt-kb-nova-premier-grounded-correctness"></a>
...
### Score mapping
<a name="prompt-kb-nova-premier-grounded-correctness-score-mapping"></a>
...
<a name="prompt-kb-nova-premier-ungrounded-correctness"></a>
...
### Score mapping
<a name="prompt-kb-nova-premier-ungrounded-correctness-score-mapping"></a>
...
## Context coverage
<a name="prompt-kb-nova-premier-context-coverage"></a>
...
### Score mapping
<a name="prompt-kb-nova-premier-context-coverage-score-mapping"></a>
+ **Not at all**: `0`
+ **Not generally**: `1`
+ **Neutral/Mixed**: `2`
+ **Generally yes**: `3`
...
## Context relevance
<a name="prompt-kb-nova-premier-context-relevance"></a>
...
### Score mapping
<a name="prompt-kb-nova-premier-context-relevance-score-mapping"></a>
+ **No**: `0`
+ **Maybe**: `1`
+ **Yes**: `2`

## Citation precision
<a name="prompt-kb-nova-premier-citation-precision"></a>
...
### Score mapping
<a name="prompt-kb-nova-premier-citation-precision-score-mapping"></a>
+ **No**: `0`
+ **Yes**: `1`

## Citation coverage
<a name="prompt-kb-nova-premier-citation-coverage"></a>
...
### Score mapping
<a name="prompt-kb-nova-premier-citation-coverage-score-mapping"></a>
+ **none is present in context**: `0`
...
## Harmfulness
<a name="prompt-kb-nova-premier-rai-harmfulness"></a>
...
### Score mapping
<a name="prompt-kb-nova-premier-rai-harmfulness-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`

## Stereotyping
<a name="prompt-kb-nova-premier-rai-stereotype"></a>
...
### Score mapping
<a name="prompt-kb-nova-premier-rai-stereotype-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`

## Refusal
<a name="prompt-kb-nova-premier-rai-refusal"></a>
...
### Score mapping
<a name="prompt-kb-nova-premier-rai-refusal-score-mapping"></a>
+ **Yes**: `1`
+ **No**: `0`